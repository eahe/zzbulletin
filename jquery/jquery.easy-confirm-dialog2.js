...
(function($) {
    $.easyconfirm2 = {};
    $.easyconfirm2.locales = {};
    $.easyconfirm2.locales.enUS = {
        title: 'Are you sure?',
        text: 'Are you sure that you want to perform this action?',
        button: ['Cancel', 'OK'],
        closeText: 'close'
    };
    $.easyconfirm2.locales.svSE = {
        title: 'Är du säker?',
        text: 'Är du säker på att du vill genomföra denna åtgärden?',
        button: ['Avbryt', 'OK'],
        closeText: 'stäng'
    };
    $.easyconfirm2.locales.itIT = {
        title: 'Sei sicuro?',
    ...
    $.fn.easyconfirm2 = function(options) {
        ...
        var locale = jQuery.extend({}, $.easyconfirm2.locales.enUS, options.locale);
